package org.motechproject.admin.server.web.controller;
...
import org.motechproject.admin.server.web.form.StartupForm;
import org.motechproject.admin.server.web.form.StartupSuggestionsForm;
import org.motechproject.admin.server.web.helper.SuggestionHelper;
import org.motechproject.admin.server.web.validator.StartupFormValidator;
...
import static org.motechproject.admin.server.web.controller.Constants.REDIRECT_HOME;
...
public class StartupController {
    ...
    public ModelAndView startup(final HttpServletRequest request) {
        ...
        if (startupManager.canLaunchBundles()) {
            view.setViewName(Constants.REDIRECT_HOME);
        } else {
    ...
    public ModelAndView submitForm(@ModelAttribute("startupSettings") @Valid StartupForm form,
        ...
        ModelAndView view = new ModelAndView(Constants.REDIRECT_HOME);
        ConfigSource configSource = (configurationService.loadBootstrapConfig() != null) ?
                configurationService.loadBootstrapConfig().getConfigSource() : ConfigSource.UI;
