package org.motechproject.admin.server.web.validator;
...
import static org.motechproject.admin.server.web.validator.ValidationUtils.validateEmptyOrWhitespace;
...
public class StartupFormValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (loginModeFromConfig == null || loginModeFromConfig.isOpenId()) {
            ...
            org.motechproject.admin.server.web.validator.ValidationUtils.validateEmptyOrWhitespace(errors, ERROR_REQUIRED, "language", queueUrl);
