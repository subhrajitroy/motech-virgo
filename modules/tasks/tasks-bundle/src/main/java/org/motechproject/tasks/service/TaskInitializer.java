        ...
        while (result && iterator.hasNext()) {
            ...
            if (step instanceof DataSource) {
                ...
                try {
                    ...
                    throw new TaskHandlerException(TaskFailureCause.FILTER, "task.error.filterError", e);
                }
            }
        }
        return result;
    ...
    private Object getDataSourceObject(DataSource dataSource, Map<String, DataProvider> providers)
        ...
        if (providers == null || providers.isEmpty()) {
            throw new TaskHandlerException(
                    TaskFailureCause.DATA_SOURCE, "task.error.notFoundDataProvider", dataSource.getType()
            );
        }
