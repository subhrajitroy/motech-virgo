...
/**
 * A wrapper over a {@link MotechEvent} with subject {@value org.motechproject.tasks.events.constants.EventSubjects#CHANNEL_DEREGISTER_SUBJECT}. Raised when a channel is deregistered from the tasks module
 */
